...
class Gwcode_fileinfo {
	...
	private function _get_file_info($file_full_path) {
		...
		$var_values_arr[$this->var_prefix.'file_extension_mime'] = $this->get_mime_by_extension($file_full_path); // if for example a .jpg file has been renamed to .gif, this value will be 'image/gif'
