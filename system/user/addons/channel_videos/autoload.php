...
/**
 * EEHarbor PHAR Loader for Channel Videos
 ...
 * @link       https://eeharbor.com/channel_videos
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'channel_videos/channel_videos.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/channel_videos';

        $namespace = 'EEHarbor\ChannelVideos';
