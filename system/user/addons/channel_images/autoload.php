<?php
/**
 * EEHarbor PHAR Loader for Channel Images
 ...
 * @link       https://eeharbor.com/channel_images
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'channel_images/channel_images.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/channel_images';

        $namespace = 'EEHarbor\ChannelImages';
