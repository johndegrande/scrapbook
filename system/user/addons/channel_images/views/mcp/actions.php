...
<h1><?php echo lang('ci:batch_actions')?></h1>
<form class="settings">
    <div class="image-filters">
        <fieldset class="col-group">
            ...
            <div class="setting-field col w-10 last">
                <?php echo form_multiselect('channels[]', $channels, '', ' class="select2" placeholder="Channels"  style="width:100%;"')?>
            </div>
        </fieldset>
        <fieldset class="col-group">
            <div class="setting-txt col w-6">
            ...
            <div class="setting-field col w-10 last">
                <?php echo form_multiselect('fields[]', $fields, '', ' class="select2" placeholder="Fields"  style="width:100%;"')?>
            </div>
        </fieldset>
        <fieldset class="col-group">
            <div class="setting-txt col w-6">
    ...
    <div class="actions action-transfer">
        ...
        <table>
            <tbody>
                <tr>
                    <td style="width:200px"><label><?php echo lang('ci:transfer_to')?></label></td>
                    <td>
    ...
    <h2 style="margin-bottom:0">
        <?php echo lang('ci:progress')?>
        <em style="float:right"><i><?php echo lang('ci:start_tip')?></i></em>
    </h2>
    ...
    <fieldset class="form-ctrls" style="margin-top:0">
        <input class="btn start_actions" type="button" value="<?php echo lang('ci:start')?>" />
    </fieldset>
</form>
