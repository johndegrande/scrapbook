...
if (!defined('CHANNEL_IMAGES_NAME')) {
    define('CHANNEL_IMAGES_NAME', $addonJson->name);
    define('CHANNEL_IMAGES_CLASS_NAME', $addonJson->shortname);
    define('CHANNEL_IMAGES_VERSION', $addonJson->version);
}
...
return array(
    ...
    'docs_url'       => 'https://eeharbor.com/docs/',
    'name'           => $addonJson->name,
    ...
    'services.singletons' => array(
        'Settings' => function ($addon) {
            return new EEHarbor\ChannelImages\Service\Settings($addon);
        },
        'Helper' => function ($addon) {
            return new EEHarbor\ChannelImages\Service\Helper($addon);
        },
        'Actions' => function ($addon) {
            return new EEHarbor\ChannelImages\Service\Actions($addon);
        },
        'Images' => function ($addon) {
            return new EEHarbor\ChannelImages\Service\Images($addon);
        }
    ),
