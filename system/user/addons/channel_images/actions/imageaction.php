...
class ImageAction
{
    ...
    public static $imageResource_dim;
    /**
    ...
    public function open_image($file)
    {
        ...
        self::$imageResource_dim['width'] = $data[0];
        self::$imageResource_dim['height'] = $data[1];
    ...
    public function save_image($dest_file='', $resource=false, $extension=false)
    {
        ...
        switch ($extension) {
            ...
            case 'jpeg':
                ...
                if ($this->image_progressive == true) {
