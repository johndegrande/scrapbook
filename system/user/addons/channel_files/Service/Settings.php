...
class Settings
{
    ...
    public $site_id;
    public $moduleClassName = CHANNEL_FILES_CLASS_NAME;
    public $moduleConfigName = CHANNEL_FILES_CLASS_NAME;
...
/* Location: ./system/user/addons/channel_files/Service/Settings.php */