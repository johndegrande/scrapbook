...
<ul class="ChannelFilesTabs" style="list-style-type: none;">
	<li style="display:inline;"><a href="#CFLocSettings" style="border: 1px solid #ccc;"><?=lang('cf:loc_settings')?></a></li>
	<li style="display:inline;"><a href="#CFFieldUI" style="border: 1px solid #ccc;"><?=lang('cf:fieldtype_settings')?></a></li>
</ul>

<div class="ChannelFilesTabsHolder">

<div class="CFLocSettings" id="CFLocSettings">
<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable" style="width:100%">
	<thead>
		<tr>
			<th style="width:40%"><?=lang('cf:pref')?></th>
			<th style="width:60%"><?=lang('cf:value')?></th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable CFUpload_local" style="width:100%">
	<thead>
		<tr>
			<th colspan="2">
				<h4>
	...
	<tbody>
		<tr>
			<td style="width:40%"><?=lang('cf:upload_location')?></td>
			<td style="width:60%"><?=form_dropdown('channel_files[locations][local][location]', $local['locations'], $locations['local']['location'] ); ?></td>
		</tr>
	</tbody>
</table>

<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable CFUpload_s3" style="width:100%">
	<thead>
		<tr>
			<th colspan="2">
				<h4>
	...
	<tbody>
		<tr>
			<td style="width:40%"><?=lang('cf:s3:key')?> <small><?=lang('cf:s3:key_exp')?></small></td>
			<td style="width:60%"><?=form_input('channel_files[locations][s3][key]', $locations['s3']['key'])?></td>
		</tr>
		<tr>
		...
		<tr>
            ...
            <td><label class="choice yes"><?=form_radio('channel_files[locations][s3][force_download]', 'yes', (($locations['s3']['force_download'] === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[locations][s3][force_download]', 'no', (($locations['s3']['force_download'] === 'no' || $locations['s3']['force_download'] === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>						
...
<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable CFUpload_cloudfiles" style="width:100%">
	<thead>
		<tr>
			<th colspan="2">
				<h4>
	...
	<tbody>
		<tr>
			<td style="width:40%"><?=lang('cf:cloudfiles:username')?></td>
			<td style="width:60%"><?=form_input('channel_files[locations][cloudfiles][username]', $locations['cloudfiles']['username'])?></td>
		</tr>
		<tr>
...
<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable CFUpload_ftp" style="width:100%">
	<thead>
		<tr>
			<th colspan="2">
				<h4>
	...
	<tbody>
		<tr>
			<td style="width:40%"><?=lang('cf:host_ip')?></td>
			<td style="width:60%"><?=form_input('channel_files[locations][ftp][hostname]', $locations['ftp']['hostname']);?></td>
		</tr>
		<tr>
			<td><?=lang('cf:port')?></td>
		...
		<tr>
            ...
            <td><label class="choice mr chosen yes"><?=form_radio('channel_files[locations][ftp][passive]', 'yes', (($locations['ftp']['passive'] === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice no"><?=form_radio('channel_files[locations][ftp][passive]', 'no', (($locations['ftp']['passive'] === 'no' || $locations['ftp']['passive'] === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>			
		...
		<tr>
            ...
            <td><label class="choice yes"><?=form_radio('channel_files[locations][ftp][ssl]', 'yes', (($locations['ftp']['ssl'] === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[locations][ftp][ssl]', 'no', (($locations['ftp']['ssl'] === 'no' || $locations['ftp']['passive'] === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>			
			<!--<td><?=form_dropdown('channel_files[locations][ftp][ssl]', array( 'no' => lang('cf:no'), 'yes' => lang('cf:yes')), $locations['ftp']['ssl']); ?></td>-->
		</tr>
	</tbody>
</table>

<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable CFUpload_sftp" style="width:100%">
	<thead>
		<tr>
			<th colspan="2">
				<h4>
	...
	<tbody>
		<tr>
			<td style="width:40%"><?=lang('cf:host_ip')?></td>
			<td style="width:60%"><?=form_input('channel_files[locations][sftp][hostname]', $locations['sftp']['hostname']);?></td>
		</tr>
		<tr>
			<td><?=lang('cf:port')?></td>
...
<table cellspacing="0" cellpadding="0" border="0" class="ChannelFilesTable" style="width:100%">
	...
	<tbody>
		...
		<tr>
            ...
            <td><label class="choice mr chosen yes"><?=form_radio('channel_files[show_stored_files]', 'yes', (($show_stored_files === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice no"><?=form_radio('channel_files[show_stored_files]', 'no', (($show_stored_files === 'no' || $show_stored_files === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>			
		...
		<tr>
            ...
            <td><label class="choice yes"><?=form_radio('channel_files[stored_files_by_author]', 'yes', (($stored_files_by_author === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[stored_files_by_author]', 'no', (($stored_files_by_author === 'no' || $stored_files_by_author === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>			
			<!--<td><?=form_dropdown('channel_files[stored_files_by_author]', array('no' => lang('cf:no'), 'yes' => lang('cf:yes')), $stored_files_by_author)?><small><?=lang('cf:limt_stored_files_author_exp')?></small></td>-->
		</tr>
		<tr>
			<td><?=lang('cf:show_import_files')?></td>
            <td>
				<label class="choice yes"><?=form_radio('channel_files[show_import_files]', 'yes', (($show_import_files === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
				<label class="choice mr chosen no"><?=form_radio('channel_files[show_import_files]', 'no', (($show_import_files === 'no' || $show_import_files === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label>
                <br>
                <small><?=lang('cf:show_import_files_exp')?></small><br>
                <?=lang('cf:import_path')?> <?=form_input('channel_files[import_path]', $import_path, 'style="border:1px solid #ccc; width:80%;"')?><br>
		...
		<tr class="cf_entry_id_folder">
            ...
            <td><label class="choice mr chosen yes"><?=form_radio('channel_files[entry_id_folder]', 'yes', (($entry_id_folder === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice no"><?=form_radio('channel_files[entry_id_folder]', 'no', (($entry_id_folder === 'no' || $entry_id_folder === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label>
            <small><?=lang('cf:store_entry_id_folder_exp')?></small></td>			
			<!--<td>
		...
		<tr class="cf_prefix_entry_id" style="<?php if ($entry_id_folder == 'yes') echo 'display:none'; ?>">
            ...
            <td><label class="choice yes"><?=form_radio('channel_files[prefix_entry_id]', 'yes', (($prefix_entry_id === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[prefix_entry_id]', 'no', (($prefix_entry_id === 'no' || $prefix_entry_id === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label>
            <small><?=lang('cf:prefix_entry_id_exp')?></small></td>			
			<!--<td>
		...
		<tr>
            ...
            <td><label class="choice yes"><?=form_radio('channel_files[show_download_btn]', 'yes', (($show_download_btn === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[show_download_btn]', 'no', (($show_download_btn === 'no' || $show_download_btn === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>			
			<!--<td>
		...
		<tr>
			...
			<td><label class="choice yes"><?=form_radio('channel_files[show_file_replace]', 'yes', (($show_file_replace === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice mr chosen no"><?=form_radio('channel_files[show_file_replace]', 'no', (($show_file_replace === 'no' || $show_file_replace === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label></td>
		...
		<tr>
            ...
            <td><label class="choice mr chosen yes"><?=form_radio('channel_files[hybrid_upload]', 'yes', (($hybrid_upload === 'yes') ? TRUE : FALSE) )?> <?=lang('cf:yes')?></label>
            <label class="choice no"><?=form_radio('channel_files[hybrid_upload]', 'no', (($hybrid_upload === 'no' || $hybrid_upload === '') ? TRUE : FALSE) )?> <?=lang('cf:no')?></label>
            <small><?=lang('cf:hybrid_upload_exp')?></small></td>			
			<!--<td>
