;(function(global, $){
    ...
    // ----------------------------------------------------------------------
		...
		checkuploadlocation_dir();
		};
		function checkuploadlocation_dir() {
		if($('.field-drop-selected input[name="channel_images[locations][local][location]"]').val()=="")
		$('.field-drop-selected input[name="channel_images[locations][local][location]"]').val('1');
		}
    function testLocation(e) {
        e.preventDefault();
        var uploadlocation = $('.field-drop-selected input[name="channel_images\[upload_location\]"]').val();
        // Post Parameters
