...
ChannelImages.OpenImageReplace = function(e){
    ...
    var currImgId = $(this).parent('.actions').parent().attr('id');
    var fieldid = $('.CIField').data('fieldid');


    $.colorbox({title: 'Replace Image', iframe: true, width:300, height:300, href:ChannelImages.AJAX_URL+'&ajax_method=display_replace_image_ui&image_id='+jsondata.image_id+'&temp_img_id='+currImgId+'&field_id='+fieldid});
